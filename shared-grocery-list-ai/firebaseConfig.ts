...
// FIX: Switched to a namespace import for 'firebase/app' to resolve module resolution errors with named exports.
...
// FIX: Replaced calls to globally imported functions with calls via the 'firebase' namespace.
