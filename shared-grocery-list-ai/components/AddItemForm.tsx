...
export const AddItemForm: React.FC<AddItemFormProps> = ({ onAddItem, isLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <label htmlFor="item-name" className="text-lg font-semibold text-gray-700">Añadir artículo</label>
