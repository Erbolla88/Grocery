...
export const UserSelector: React.FC<UserSelectorProps> = ({ users, currentUser, setCurrentUser, t }) => {
  const userColors = {
  ...
  return (
    <div>
      <p className="text-sm font-medium text-gray-600 mb-2 ml-1">{t.shoppingAs}</p>
