...
import { USERS, SUPERMARKETS, CATEGORY_TRANSLATIONS } from './constants.ts';
import { categorizeAndIconifyItem } from './services/geminiService.ts';
import type { User, GroceryItem, Supermarket, Language, QuickAddConstant, Multilingual } from './types.ts';
import { database, auth } from './firebaseConfig.ts';
import { onAuthStateChanged, signOut, type User as FirebaseUser } from 'firebase/auth';
import { ref, onValue, push, update, remove, child } from 'firebase/database';
import { QuickAddItem } from './components/QuickAddItem.tsx';
